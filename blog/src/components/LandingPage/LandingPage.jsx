  ...
  return (
    <>
      <div className="h-[750px] bg-gradient-to-t from-black to-gray-900 font-roboto">
        <Container>
          <div className="h-full flex justify-between animate-reveal  ">
            <div className="left h-full w-auto tracking-wider flex flex-col justify-center">
              ...
              <div className="my-6 text-2xl text-blush opacity-90 tracking-widest inline-block ">
                <h5 className=" border-r-[3px] border-r-blush  typeWriter">
                  A haven for thoughtful explorers.
                </h5>
              </div>
              <button className="mt-9 text-2xl text-blush border-[1px] border-blush font-medium rounded-full py-2 w-[200px] text-center buttonGlow">
                Get Started
              </button>
            </div>
